...
class Trainer:
    ...
    def train(self, train_data, dev_data, nb_epochs):
        ...
        train_loader = DataLoader(train_dataset, batch_size=self.batch_size, shuffle=True, collate_fn=dynamic_collate_fn)
    ...
    def _run_epoch(self, dataloader, train):
        ...
        with tqdm(dataloader, unit="batch") as pbar:
            for batch in pbar:
                ...
                inputs = [v.to(self.device) for k, v in batch.items() if k not in ['extracted_head', 'extracted_deprel']]
